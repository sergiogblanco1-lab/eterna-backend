...
def resumen(order_id: str):
    ...
    if has_reaction:
        reaction_share_target = order.get("reaction_public_url") or f"{PUBLIC_BASE_URL}/reaccion/{order_id}"
...
def reaccion(order_id: str):
    ...
    share_url = order.get("reaction_public_url") or f"{PUBLIC_BASE_URL}/reaccion/{order_id}"
